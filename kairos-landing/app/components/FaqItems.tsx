...
const FaqItems = ({ item, index }: { item: FaqItem; index: number }) => {
  const [activeid, setActive] = useState<string | number | null>(null);
  ...
  return (
    <div className="relative z-2 mb-16">
      ...
      >
        <div className="flex-1">
          ...
          <div
            className={clsx(
              ...
              active && "max-lg:text-p1 text-white"
            )}
          >
            {item.question}
          </div>
        ...
        <div
          className={clsx(
            "faq-icon relative flex size-12 items-center justify-center rounded-full border-2 border-s2 shadow-400 transition-all duration-500 group-hover:border-s1",
